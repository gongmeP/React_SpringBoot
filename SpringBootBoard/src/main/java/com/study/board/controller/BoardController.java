...
import com.study.board.PageUtil;
...
public class BoardController {
    ...
    public String boardList(Model model, @PageableDefault(page = 0, size = 10, sort = "id",
        ...
        PageDto pageDto = PageUtil.page(list);

        model.addAttribute("List", list);
        model.addAttribute("nowPage", pageDto.getNowPage());
    ...
    public String boardModifty(@PathVariable("id") Integer id, Model model) {
